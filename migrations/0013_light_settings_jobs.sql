...
-- Job queue for the light-settings ComfyUI workflow (turns fixtures on/off and
-- shifts scene lighting via a free-text instruction) — same shape as
-- object_replacement_jobs (0007) and texture_replacement_jobs (0008), minus a
-- second reference image since this workflow only ever takes one scene photo.
CREATE TABLE light_settings_jobs (
