...
import { DEFAULT_UPLOADS_BUCKET_NAME, type StyleTransferRequest } from '$lib/api/contract';
...
export const AC9_IMAGE: ManagedImageInput = {
	mediaKey: `${DEFAULT_UPLOADS_BUCKET_NAME}/ac9-fixture-room.webp`,
	mime: 'image/webp',
	size: 2048,
	dimensions: [1024, 768]
};
...
export const AC9_REFERENCE_IMAGE: ManagedImageInput = {
	mediaKey: `${DEFAULT_UPLOADS_BUCKET_NAME}/ac9-fixture-style-reference.jpg`,
	mime: 'image/jpeg',
	size: 4096,
	dimensions: [900, 1200]
};
