...
// image_generation_details.input_hash (see findGenerationSourceByHash). Not a security
...
// Guards the dedup path in POST /api/uploads: image_generation_details.input_url can
// hold a generated output URL, so a hash lookup match must be confirmed to actually
