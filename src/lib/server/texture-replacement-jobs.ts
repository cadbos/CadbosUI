...
export async function createTextureReplacementJob(
	...
	await db.run(
		sql`INSERT INTO texture_replacement_jobs
			...
			VALUES (${input.id}, ${input.userId}, ${input.comfyPromptId}, ${input.sceneMediaId}, ${input.sessionId}, ${input.referenceMediaId}, ${input.replacementSurface}, ${input.cost}, 'processing', ${input.createdAt}, ${input.createdAt})`
	);
